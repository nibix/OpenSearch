...
public final class PmeKeyDerivation {
    static final String FOOTER_KEY_CONTEXT = "opensearch/parquet-pme/footer-key/v1";
    ...
    public static byte[] deriveFooterKey(byte[] dataKey, byte[] messageId) {
        ...
        try {
            ...
            byte[] contextBytes = FOOTER_KEY_CONTEXT.getBytes(StandardCharsets.UTF_8);
